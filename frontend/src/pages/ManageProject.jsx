            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <section className="space-y-4">
                ...
                <label className="group relative w-full h-24 rounded-2xl border-2 border-dashed border-gray-300 bg-gray-50 hover:bg-blue-50/50 hover:border-[#2C71B8] flex items-center justify-center transition-all duration-300 cursor-pointer overflow-hidden">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-white group-hover:bg-[#2C71B8] rounded-xl shadow-sm flex items-center justify-center transition-all duration-300">
                      <UploadCloud size={20} className="text-gray-400 group-hover:text-white transition-colors" />
                    </div>
                    <div className="text-left">
                      <p className="text-sm font-bold text-gray-600 group-hover:text-[#2C71B8] transition-colors">Upload media utama</p>
                      <p className="text-[10px] text-gray-400 mt-0.5">Gambar, PDF, MP4, MP3</p>
                    </div>
                  </div>
                </label>
                  ...
                  <div className="space-y-2.5 mt-2">
                    {mainMediaFiles.map((file, idx) => (
                      <div key={idx} className="flex items-center justify-between p-3 bg-gray-50 border border-gray-100 rounded-xl">
                        ...
                        <button type="button" onClick={() => removeFile('main', idx)} className="p-2 text-gray-400 hover:text-red-500 hover:bg-red-50 rounded-lg transition shrink-0"><X size={16} /></button>
                      </div>
                    ))}
                  </div>
                )}
              ...
              <section className="space-y-4">
                ...
                <label className="group relative w-full h-24 rounded-2xl border-2 border-dashed border-gray-300 bg-gray-50 hover:bg-emerald-50/50 hover:border-emerald-500 flex items-center justify-center transition-all duration-300 cursor-pointer overflow-hidden">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-white group-hover:bg-emerald-500 rounded-xl shadow-sm flex items-center justify-center transition-all duration-300">
                      <UploadCloud size={20} className="text-gray-400 group-hover:text-white transition-colors" />
                    </div>
                    <div className="text-left">
                      <p className="text-sm font-bold text-gray-600 group-hover:text-emerald-500 transition-colors">Upload media tambahan</p>
                      <p className="text-[10px] text-gray-400 mt-0.5">Dokumen, sketsa, dll</p>
                    </div>
                  </div>
                </label>
                  ...
                  <div className="space-y-2.5 mt-2">
                    {additionalMediaFiles.map((file, idx) => (
                      <div key={idx} className="flex items-center justify-between p-3 bg-gray-50 border border-gray-100 rounded-xl">
                        ...
                        <button type="button" onClick={() => removeFile('additional', idx)} className="p-2 text-gray-400 hover:text-red-500 hover:bg-red-50 rounded-lg transition shrink-0"><X size={16} /></button>
                      </div>
                    ))}
                  </div>
                )}
